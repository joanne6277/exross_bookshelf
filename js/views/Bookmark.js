    ...
    filters: [
        {
            ...
            options: [
                ...
                { value: 'highlight', label: '劃線', active: false },
                { value: 'note', label: '筆記', active: false }
            ] // removed hideOnMobile
        },
        {
            id: 'custom-ops', label: '', type: 'custom',
            customHTML: `
            ...
            mobileCustomHTML: `
            <!-- Color Filter (Mobile) -->
            <button id="mobile-color-btn" class="flex-shrink-0 flex items-center justify-center h-10 w-10 bg-white border border-border-color text-text-primary rounded-lg hover:border-accent transition-colors ml-1">
                <div class="w-4 h-4 rounded-full border border-gray-300 relative overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-tr from-yellow-300 via-red-300 to-blue-300 opacity-80"></div>
                </div>
            </button>
