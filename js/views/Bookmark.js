        ...
        <div class="flex flex-col h-full bg-white rounded-2xl shadow-sm border border-border-color overflow-hidden">
            ...
            <div class="flex flex-1 overflow-hidden relative">
                ...
                <div class="w-full md:flex-1 min-w-0 flex flex-col bg-gray-50/30 relative">
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0">
                             <div class="relative" id="color-filter-dropdown-container">
                                <button id="color-filter-trigger" 
                                    class="flex items-center gap-2 bg-white border border-border-color rounded-lg px-3 py-1.5 text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-blue-300 hover:border-accent transition-colors min-w-[100px] justify-between">
                                    <div class="flex items-center gap-2">
                                        <div id="color-filter-preview" class="w-4 h-4 rounded-full border border-gray-300 bg-transparent relative overflow-hidden">
                                           <!-- Initial: Multi-color wheel indication for 'All' -->
                    ...
                    <!-- Mobile Book Capsules (visible on mobile when no search) -->
                    <div id="mobile-book-capsules-container" class="md:hidden px-3 py-2 border-b border-border-color bg-white overflow-x-auto no-scrollbar flex gap-2 items-center">
