...
import { createFaqSectionHTML, initFaqSectionEvents } from '../components/personal-center/FaqSection.js';
...
const SECTIONS = [
    ...
    { id: 'faq', label: '常見問題', icon: 'help-circle', createHTML: createFaqSectionHTML, initEvents: initFaqSectionEvents },
];
